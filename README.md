[![Build Status](https://dev.azure.com/suresh-mydevops/SureshDevOpsProject/_apis/build/status%2Fsksureshct.ContosoAir?branchName=master)](https://dev.azure.com/suresh-mydevops/SureshDevOpsProject/_build/latest?definitionId=5&branchName=master)
